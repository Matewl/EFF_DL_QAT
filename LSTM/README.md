...
Сравнение 5 методов Quantization Aware Training (QAT) на **LSTM** для задачи классификации текста.
Датасет: **Yelp Polarity** (150k train / 15k test сплит). Метрика: **ROC-AUC** на валидационном датасете.
...
| :--- | :--- | :--- | :--- |
| **NDCG / AUC (test)** | 0.9849 | 0.9843 | **0.0006** |
